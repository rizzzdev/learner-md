...
function App() {
  ...
  const currentMaterial =
    selectedMaterial !== null && currentCourse
      ? currentCourse.materials[selectedMaterial]
      : null;

  // Breadcrumb
  let breadcrumb = loading ? (
    "Memuat data..."
  ) : error ? (
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <header className="mb-8 flex justify-between items-center border-b border-gray-700 pb-4">
        <div>
          <h1
            className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-purple-500 cursor-pointer"
            onClick={handleBackToCourses}
          >
            MD Learner by rizzzdev
          </h1>
